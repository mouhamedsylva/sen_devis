# 🎨 Animations Quotes Screens - SenDevis
...
#### Cartes de Devis (Cascade)
```dart
Dismissible(...).animate().fadeIn(
...
**Effet :**
- Apparition après les détails (300ms)
- Cascade progressive
...
**Effet :**
- Apparition après le client (400ms)
- Section importante du formulaire
...
**Effet :**
- Apparition après les articles (500ms)
- Cascade continue
...
**Effet :**
- Apparition après la main d'œuvre (600ms)
...
**Effet :**
- Apparition après les totaux (700ms)
- Conditions du devis
...
**Effet :**
- Apparition après les conditions (800ms)
- Avant-dernière section
...
**Effet :**
- Dernier élément à apparaître (900ms)
...
| Élément | Délai | Durée | Total |
|---------|-------|-------|-------|
| Détails devis | 200ms | 500ms | 700ms |
| Client | 300ms | 500ms | 800ms |
| Articles | 400ms | 500ms | 900ms |
| Main d'œuvre | 500ms | 500ms | 1000ms |
| Totaux | 600ms | 500ms | 1100ms |
| Conditions | 700ms | 500ms | 1200ms |
| Notes | 800ms | 500ms | 1300ms |
| Bouton | 900ms | 500ms | 1400ms |

**Durée totale de la séquence :** ~1.4 secondes
...
### Formulaire de Devis
- **Cascade progressive** : Délai de 100ms entre chaque section
- **Hiérarchie claire** : Guide l'utilisateur du haut vers le bas
- **Durée optimale** : 1.4 secondes pour tout le formulaire
- **8 sections animées** : Formulaire complet et complexe
...
✅ Formulaire complexe moins intimidant  
✅ État vide engageant  
...
- [x] Animation des cartes de devis (cascade)
- [x] Animation de l'état vide (icône, textes, bouton)
- [x] Animation du formulaire (8 sections en cascade)
...
Les écrans de devis sont maintenant animés avec :
- **13+ éléments animés** (cartes, formulaire, état vide)
...
Les devis se construisent progressivement et le formulaire complexe guide l'utilisateur naturellement ! 🚀
